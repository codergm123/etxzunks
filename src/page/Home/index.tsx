                        ...
                        <Col span={24} className="relative full-screen "  >
                            ...
                            <Row className="full-window absolute menu-bar">
                                ...
                                <Col xs={{span:22,offset:1}} sm={{span:18,offset:3}}>
                                    ...
                                    <div className="title">
                                        <span>Say hello to Etczunks!</span>
                                        
                                        <div style={{paddingTop:'14px'}}>The Etczunks are 10,000 uniquely generated characters developed on Ethereum Classic blockchain.<br/>Each Etczunk is different and can be owned by a single person. Mint your Etczunk for just 2 ETC.</div> 
                                        
                                        <div style={{paddingTop:'14px'}}>The marketplace will open when all Etczunks have been minted.</div>
                                    </div>
